...
public class RegisterActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        emailET = findViewById(com.example.foodwise.R.id.emailET1);
        passwordET = findViewById(com.example.foodwise.R.id.passwordET1);
        passwordET2 = findViewById(com.example.foodwise.R.id.passwordET2);
        registerBTN = findViewById(com.example.foodwise.R.id.registerBTN);
        goToLoginBTN = findViewById(com.example.foodwise.R.id.goToLoginBTN);
        progressBar = findViewById(com.example.foodwise.R.id.progressBar1);
